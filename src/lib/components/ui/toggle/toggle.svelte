	...
	export const toggleVariants = tv({
		...
		variants: {
			variant: {
				...
				outlineGroup:
					'border-input hover:bg-muted border bg-transparent shadow-xs *:rounded-none! first:rounded-l-md! last:rounded-r-md! first:rounded-r-none! last:rounded-l-none!'
			},
			size: {
				default:
